#!/bin/bash
xsetwacom set "Tablet Monitor Pen stylus" Button 2 3
xsetwacom set "Tablet Monitor Pen stylus" Button 3 2
xsetwacom set "Tablet Monitor Pen stylus" MapToOutput HEAD-2
